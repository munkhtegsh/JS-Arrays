...
//evens array (all the even values from numbersArray) and the second item in 
//the Array being the odds array (all the odd values from numbersArray).
...
//number (by invoking getRandomArbitrary), then loop through the 
